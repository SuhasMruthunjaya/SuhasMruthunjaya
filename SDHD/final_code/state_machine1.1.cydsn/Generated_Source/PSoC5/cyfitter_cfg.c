...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000430u)
...
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000440u)
...
uint8 CYXDATA * const CYCODE ADC_VtgDiv_AMux__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE ADC_VtgDiv_AMux__maskTable[2] = {
	0x40u, 
	0x00u, 
};

/*******************************************************************************
* Function Name: ADC_VtgDiv_AMux_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ADC_VtgDiv_AMux_Set(uint8 channel)
{
	if (channel < 2)
	{
		*ADC_VtgDiv_AMux__addrTable[channel] |= ADC_VtgDiv_AMux__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: ADC_VtgDiv_AMux_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ADC_VtgDiv_AMux_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*ADC_VtgDiv_AMux__addrTable[channel] &= (uint8)~ADC_VtgDiv_AMux__maskTable[channel];
	}
}
