/**
*  file    SIGNAL_ULTRASONICSENSOR_signal.h
*
*  brief   signal base class for signal Signal_UltrasonicSensor
*
...
#ifndef SIGNAL_ULTRASONICSENSOR_SIGNAL_H_INCLUDED
#define SIGNAL_ULTRASONICSENSOR_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*SIGNAL_ULTRASONICSENSOR_driverIn_t)(SIGNAL_ULTRASONICSENSOR_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*SIGNAL_ULTRASONICSENSOR_driverOut_t)( const SIGNAL_ULTRASONICSENSOR_data_t * const);
...
/**
 * Instances of the struct SIGNAL_ULTRASONICSENSOR_cfg_t represent the signal object configuration.
 */
struct SIGNAL_ULTRASONICSENSOR_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    SIGNAL_ULTRASONICSENSOR_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   SIGNAL_ULTRASONICSENSOR_driverOut_t const outDriver;
...
typedef const struct SIGNAL_ULTRASONICSENSOR_cfg_s SIGNAL_ULTRASONICSENSOR_cfg_t;
...
/**
 * Instances of the struct SIGNAL_ULTRASONICSENSOR_t represent the signal objects.
 * A signal object contains the current application value 'value' as well as relevant meta data.
 */
struct SIGNAL_ULTRASONICSENSOR_s
{                                                                                                                      

	/**
	 * Data buffer for the application value
	 */
    SIGNAL_ULTRASONICSENSOR_data_t value;
     ...
     */
	const SIGNAL_ULTRASONICSENSOR_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct SIGNAL_ULTRASONICSENSOR_s SIGNAL_ULTRASONICSENSOR_t;
 ...
 *
 * @param  SIGNAL_ULTRASONICSENSOR_t * const signal: Pointer to the signal object which will be initialised
 * @param const Signal_UltrasonicSensor_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SIGNAL_ULTRASONICSENSOR_init( SIGNAL_ULTRASONICSENSOR_t * const signal, const SIGNAL_ULTRASONICSENSOR_data_t * const value )
{                                                                                                                      
 ...
 *
 * @param  SIGNAL_ULTRASONICSENSOR_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_SIGNAL_ULTRASONICSENSOR_getStatus( const SIGNAL_ULTRASONICSENSOR_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_SIGNAL_ULTRASONICSENSOR_setStatus( SIGNAL_ULTRASONICSENSOR_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_SIGNAL_ULTRASONICSENSOR_getAge( const SIGNAL_ULTRASONICSENSOR_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_SIGNAL_ULTRASONICSENSOR_incAge(  SIGNAL_ULTRASONICSENSOR_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  SIGNAL_ULTRASONICSENSOR_t * const signal: Pointer to the signal object
 * @return Signal_UltrasonicSensor_data_t: current value of the application data buffer
 *
 **/
inline SIGNAL_ULTRASONICSENSOR_data_t RTE_SIGNAL_ULTRASONICSENSOR_get( const SIGNAL_ULTRASONICSENSOR_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  SIGNAL_ULTRASONICSENSOR_t * const signal: Pointer to the signal object
 * @param  Signal_UltrasonicSensor_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SIGNAL_ULTRASONICSENSOR_set(SIGNAL_ULTRASONICSENSOR_t * const signal, const SIGNAL_ULTRASONICSENSOR_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_SIGNAL_ULTRASONICSENSOR_pullPort( SIGNAL_ULTRASONICSENSOR_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {
	  SIGNAL_ULTRASONICSENSOR_data_t value = signal->value;
      ret = signal->pSigCfg->inDriver(&value);
                                                                                                                       
      if ( ret == RC_SUCCESS )                                                                                         
      {
    	  //Critical Section
    	  RTE_SIGNAL_ULTRASONICSENSOR_set(signal, value);
      }
      else
      {
    	  //Set the status and fire error event if available
    	  RTE_SIGNAL_ULTRASONICSENSOR_setStatus( signal, RTE_SIGNALSTATUS_INVALID );
 ...
 *
 **/
inline RC_t RTE_SIGNAL_ULTRASONICSENSOR_pushPort( const SIGNAL_ULTRASONICSENSOR_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
