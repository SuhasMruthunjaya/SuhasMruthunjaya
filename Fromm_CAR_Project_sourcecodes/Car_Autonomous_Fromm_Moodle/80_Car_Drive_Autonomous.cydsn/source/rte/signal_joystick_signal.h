/**
*  file    SIGNAL_JOYSTICK_signal.h
*
*  brief   signal base class for signal Signal_Joystick
*
...
#ifndef SIGNAL_JOYSTICK_SIGNAL_H_INCLUDED
#define SIGNAL_JOYSTICK_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*SIGNAL_JOYSTICK_driverIn_t)(SIGNAL_JOYSTICK_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*SIGNAL_JOYSTICK_driverOut_t)( const SIGNAL_JOYSTICK_data_t * const);
...
/**
 * Instances of the struct SIGNAL_JOYSTICK_cfg_t represent the signal object configuration.
 */
struct SIGNAL_JOYSTICK_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    SIGNAL_JOYSTICK_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   SIGNAL_JOYSTICK_driverOut_t const outDriver;
...
typedef const struct SIGNAL_JOYSTICK_cfg_s SIGNAL_JOYSTICK_cfg_t;
...
{                                                                                                                      
     ...
     */
	const SIGNAL_JOYSTICK_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct SIGNAL_JOYSTICK_s SIGNAL_JOYSTICK_t;
 ...
 *
 * @param  SIGNAL_JOYSTICK_t * const signal: Pointer to the signal object which will be initialised
 * @param const Signal_Joystick_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SIGNAL_JOYSTICK_init( SIGNAL_JOYSTICK_t * const signal, const SIGNAL_JOYSTICK_data_t * const value )
{                                                                                                                      
 ...
 *
 * @param  SIGNAL_JOYSTICK_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_SIGNAL_JOYSTICK_getStatus( const SIGNAL_JOYSTICK_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_SIGNAL_JOYSTICK_setStatus( SIGNAL_JOYSTICK_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_SIGNAL_JOYSTICK_getAge( const SIGNAL_JOYSTICK_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_SIGNAL_JOYSTICK_incAge(  SIGNAL_JOYSTICK_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  SIGNAL_JOYSTICK_t * const signal: Pointer to the signal object
 * @return Signal_Joystick_data_t: current value of the application data buffer
 *
 **/
inline SIGNAL_JOYSTICK_data_t RTE_SIGNAL_JOYSTICK_get( const SIGNAL_JOYSTICK_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  SIGNAL_JOYSTICK_t * const signal: Pointer to the signal object
 * @param  Signal_Joystick_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SIGNAL_JOYSTICK_set(SIGNAL_JOYSTICK_t * const signal, const SIGNAL_JOYSTICK_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_SIGNAL_JOYSTICK_pullPort( SIGNAL_JOYSTICK_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   if ( NULL != signal->pSigCfg->inDriver )
   {
      ...
      {
    	  //Critical Section
    	  RTE_SIGNAL_JOYSTICK_set(signal, value);
      }
      else
      {
    	  //Set the status and fire error event if available
    	  RTE_SIGNAL_JOYSTICK_setStatus( signal, RTE_SIGNALSTATUS_INVALID );
 ...
 *
 **/
inline RC_t RTE_SIGNAL_JOYSTICK_pushPort( const SIGNAL_JOYSTICK_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
