/**
*  file    SIGNAL_EVENT_signal.h
*
*  brief   signal base class for signal Signal_Event
*
...
#ifndef SIGNAL_EVENT_SIGNAL_H_INCLUDED
#define SIGNAL_EVENT_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*SIGNAL_EVENT_driverIn_t)(SIGNAL_EVENT_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*SIGNAL_EVENT_driverOut_t)( const SIGNAL_EVENT_data_t * const);
...
/**
 * Instances of the struct SIGNAL_EVENT_cfg_t represent the signal object configuration.
 */
struct SIGNAL_EVENT_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    SIGNAL_EVENT_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   SIGNAL_EVENT_driverOut_t const outDriver;
...
typedef const struct SIGNAL_EVENT_cfg_s SIGNAL_EVENT_cfg_t;
...
{                                                                                                                      
     ...
     */
	const SIGNAL_EVENT_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct SIGNAL_EVENT_s SIGNAL_EVENT_t;
 ...
 *
 * @param  SIGNAL_EVENT_t * const signal: Pointer to the signal object which will be initialised
 * @param const Signal_Event_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SIGNAL_EVENT_init( SIGNAL_EVENT_t * const signal, const SIGNAL_EVENT_data_t * const value )
{                                                                                                                      
 ...
 *
 * @param  SIGNAL_EVENT_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_SIGNAL_EVENT_getStatus( const SIGNAL_EVENT_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_SIGNAL_EVENT_setStatus( SIGNAL_EVENT_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_SIGNAL_EVENT_getAge( const SIGNAL_EVENT_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_SIGNAL_EVENT_incAge(  SIGNAL_EVENT_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  SIGNAL_EVENT_t * const signal: Pointer to the signal object
 * @return Signal_Event_data_t: current value of the application data buffer
 *
 **/
inline SIGNAL_EVENT_data_t RTE_SIGNAL_EVENT_get( const SIGNAL_EVENT_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  SIGNAL_EVENT_t * const signal: Pointer to the signal object
 * @param  Signal_Event_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SIGNAL_EVENT_set(SIGNAL_EVENT_t * const signal, const SIGNAL_EVENT_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_SIGNAL_EVENT_pullPort( SIGNAL_EVENT_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   if ( NULL != signal->pSigCfg->inDriver )
   {
      ...
      {
    	  //Critical Section
    	  RTE_SIGNAL_EVENT_set(signal, value);
      }
      else
      {
    	  //Set the status and fire error event if available
    	  RTE_SIGNAL_EVENT_setStatus( signal, RTE_SIGNALSTATUS_INVALID );
 ...
 *
 **/
inline RC_t RTE_SIGNAL_EVENT_pushPort( const SIGNAL_EVENT_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
