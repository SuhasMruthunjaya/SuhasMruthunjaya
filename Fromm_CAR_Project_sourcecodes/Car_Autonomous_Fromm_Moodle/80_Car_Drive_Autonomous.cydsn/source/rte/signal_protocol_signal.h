/**
*  file    SIGNAL_PROTOCOL_signal.h
*
*  brief   signal base class for signal Signal_Protocol
*
...
#ifndef SIGNAL_PROTOCOL_SIGNAL_H_INCLUDED
#define SIGNAL_PROTOCOL_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*SIGNAL_PROTOCOL_driverIn_t)(SIGNAL_PROTOCOL_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*SIGNAL_PROTOCOL_driverOut_t)( const SIGNAL_PROTOCOL_data_t * const);
...
/**
 * Instances of the struct SIGNAL_PROTOCOL_cfg_t represent the signal object configuration.
 */
struct SIGNAL_PROTOCOL_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    SIGNAL_PROTOCOL_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   SIGNAL_PROTOCOL_driverOut_t const outDriver;
...
typedef const struct SIGNAL_PROTOCOL_cfg_s SIGNAL_PROTOCOL_cfg_t;
...
{                                                                                                                      
     ...
     */
	const SIGNAL_PROTOCOL_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct SIGNAL_PROTOCOL_s SIGNAL_PROTOCOL_t;
 ...
 *
 * @param  SIGNAL_PROTOCOL_t * const signal: Pointer to the signal object which will be initialised
 * @param const Signal_Protocol_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SIGNAL_PROTOCOL_init( SIGNAL_PROTOCOL_t * const signal, const SIGNAL_PROTOCOL_data_t * const value )
{                                                                                                                      
 ...
 *
 * @param  SIGNAL_PROTOCOL_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_SIGNAL_PROTOCOL_getStatus( const SIGNAL_PROTOCOL_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_SIGNAL_PROTOCOL_setStatus( SIGNAL_PROTOCOL_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_SIGNAL_PROTOCOL_getAge( const SIGNAL_PROTOCOL_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_SIGNAL_PROTOCOL_incAge(  SIGNAL_PROTOCOL_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  SIGNAL_PROTOCOL_t * const signal: Pointer to the signal object
 * @return Signal_Protocol_data_t: current value of the application data buffer
 *
 **/
inline SIGNAL_PROTOCOL_data_t RTE_SIGNAL_PROTOCOL_get( const SIGNAL_PROTOCOL_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  SIGNAL_PROTOCOL_t * const signal: Pointer to the signal object
 * @param  Signal_Protocol_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SIGNAL_PROTOCOL_set(SIGNAL_PROTOCOL_t * const signal, const SIGNAL_PROTOCOL_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_SIGNAL_PROTOCOL_pullPort( SIGNAL_PROTOCOL_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   if ( NULL != signal->pSigCfg->inDriver )
   {
      ...
      {
    	  //Critical Section
    	  RTE_SIGNAL_PROTOCOL_set(signal, value);
      }
      else
      {
    	  //Set the status and fire error event if available
    	  RTE_SIGNAL_PROTOCOL_setStatus( signal, RTE_SIGNALSTATUS_INVALID );
 ...
 *
 **/
inline RC_t RTE_SIGNAL_PROTOCOL_pushPort( const SIGNAL_PROTOCOL_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
