...
#define US_Timer_Resolution                 32u
...
#define US_Timer_EnableTriggerMode          1u
#define US_Timer_InterruptOnCaptureCount    1u
...
#define US_Timer_INIT_PERIOD             99999u
#define US_Timer_INIT_CAPTURE_MODE       ((uint8)((uint8)2u << US_Timer_CTRL_CAP_MODE_SHIFT))
#define US_Timer_INIT_TRIGGER_MODE       ((uint8)((uint8)1u << US_Timer_CTRL_TRIG_MODE_SHIFT))
#if (US_Timer_UsingFixedFunction)
    #define US_Timer_INIT_INTERRUPT_MODE (((uint8)((uint8)1u << US_Timer_STATUS_TC_INT_MASK_SHIFT)) | \
                                                  ((uint8)((uint8)1 << US_Timer_STATUS_CAPTURE_INT_MASK_SHIFT)))
#else
    #define US_Timer_INIT_INTERRUPT_MODE (((uint8)((uint8)1u << US_Timer_STATUS_TC_INT_MASK_SHIFT)) | \
                                                 ((uint8)((uint8)1 << US_Timer_STATUS_CAPTURE_INT_MASK_SHIFT)) | \
...
***************************************/
    ...
    ***************************************/
    ...
    #define US_Timer_CONTROL             (* (reg8 *) US_Timer_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
        ...
        #define US_Timer_CAPTURE_LSB         (* (reg8 *) US_Timer_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define US_Timer_CAPTURE_LSB_PTR       ((reg8 *) US_Timer_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define US_Timer_PERIOD_LSB          (* (reg8 *) US_Timer_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define US_Timer_PERIOD_LSB_PTR        ((reg8 *) US_Timer_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define US_Timer_COUNTER_LSB         (* (reg8 *) US_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
        #define US_Timer_COUNTER_LSB_PTR       ((reg8 *) US_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
    #elif(US_Timer_Resolution <= 16u) /* 8-bit Timer */
        #if(CY_PSOC3) /* 8-bit addres space */
            #define US_Timer_CAPTURE_LSB         (* (reg16 *) US_Timer_TimerUDB_sT32_timerdp_u0__F0_REG )
            #define US_Timer_CAPTURE_LSB_PTR       ((reg16 *) US_Timer_TimerUDB_sT32_timerdp_u0__F0_REG )
            #define US_Timer_PERIOD_LSB          (* (reg16 *) US_Timer_TimerUDB_sT32_timerdp_u0__D0_REG )
            #define US_Timer_PERIOD_LSB_PTR        ((reg16 *) US_Timer_TimerUDB_sT32_timerdp_u0__D0_REG )
            #define US_Timer_COUNTER_LSB         (* (reg16 *) US_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
            #define US_Timer_COUNTER_LSB_PTR       ((reg16 *) US_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
        #else /* 16-bit address space */
            #define US_Timer_CAPTURE_LSB         (* (reg16 *) US_Timer_TimerUDB_sT32_timerdp_u0__16BIT_F0_REG )
            #define US_Timer_CAPTURE_LSB_PTR       ((reg16 *) US_Timer_TimerUDB_sT32_timerdp_u0__16BIT_F0_REG )
            #define US_Timer_PERIOD_LSB          (* (reg16 *) US_Timer_TimerUDB_sT32_timerdp_u0__16BIT_D0_REG )
            #define US_Timer_PERIOD_LSB_PTR        ((reg16 *) US_Timer_TimerUDB_sT32_timerdp_u0__16BIT_D0_REG )
            #define US_Timer_COUNTER_LSB         (* (reg16 *) US_Timer_TimerUDB_sT32_timerdp_u0__16BIT_A0_REG )
            #define US_Timer_COUNTER_LSB_PTR       ((reg16 *) US_Timer_TimerUDB_sT32_timerdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */
    #elif(US_Timer_Resolution <= 24u)/* 24-bit Timer */
        #define US_Timer_CAPTURE_LSB         (* (reg32 *) US_Timer_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define US_Timer_CAPTURE_LSB_PTR       ((reg32 *) US_Timer_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define US_Timer_PERIOD_LSB          (* (reg32 *) US_Timer_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define US_Timer_PERIOD_LSB_PTR        ((reg32 *) US_Timer_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define US_Timer_COUNTER_LSB         (* (reg32 *) US_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
        #define US_Timer_COUNTER_LSB_PTR       ((reg32 *) US_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
    #else /* 32-bit Timer */
            ...
            #define US_Timer_CAPTURE_LSB         (* (reg32 *) US_Timer_TimerUDB_sT32_timerdp_u0__32BIT_F0_REG )
            #define US_Timer_CAPTURE_LSB_PTR       ((reg32 *) US_Timer_TimerUDB_sT32_timerdp_u0__32BIT_F0_REG )
            #define US_Timer_PERIOD_LSB          (* (reg32 *) US_Timer_TimerUDB_sT32_timerdp_u0__32BIT_D0_REG )
            #define US_Timer_PERIOD_LSB_PTR        ((reg32 *) US_Timer_TimerUDB_sT32_timerdp_u0__32BIT_D0_REG )
            #define US_Timer_COUNTER_LSB         (* (reg32 *) US_Timer_TimerUDB_sT32_timerdp_u0__32BIT_A0_REG )
            #define US_Timer_COUNTER_LSB_PTR       ((reg32 *) US_Timer_TimerUDB_sT32_timerdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */ 
    #endif

    #define US_Timer_COUNTER_LSB_PTR_8BIT       ((reg8 *) US_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
