 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_3[TASK_3_STACK_SIZE];	/* Task 3 (TzCtrl) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 3))
    #define TASK_4_STACK_SIZE 0/4 // size = 0 bytes
    int EE_cortex_mx_stack_4[TASK_4_STACK_SIZE];	/* Task 4 (tsk_CyclicDispatcher) */
    #endif
    #if ((2 == 2) && (EE_MAX_TASK > 4))
    #define TASK_5_STACK_SIZE 1600/4 // size = 1600 bytes
    int EE_cortex_mx_stack_5[TASK_5_STACK_SIZE];	/* Task 5 (tsk_EventDispatcher) */
    #endif
    ...
    #endif
    #if EE_MAX_TASK > 3
        ,Tsk4	 /* tsk_CyclicDispatcher*/
    #endif
    #if EE_MAX_TASK > 4
        ,Tsk5	 /* tsk_EventDispatcher*/
    #endif
    #if EE_MAX_TASK > 5
        ,Tsk6	 /* Task_6*/
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_3_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_3[(TASK_3_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])} 	/* TzCtrl*/
        #endif
        #ifdef TASK_4_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_4[(TASK_4_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_CyclicDispatcher*/
        #endif
        #ifdef TASK_5_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_5[(TASK_5_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_EventDispatcher*/
        #endif
        #ifdef TASK_6_STACK_SIZE
 ...
 **************************************************************************/
    ...
    #endif
    #if EE_MAX_TASK > 3
    DeclareTask(tsk_CyclicDispatcher);
    #endif
    #if EE_MAX_TASK > 4
    DeclareTask(tsk_EventDispatcher);
    #endif
    #if EE_MAX_TASK > 5
    DeclareTask(Task_6);
    #endif
    ...
    #endif
    #if EE_MAX_TASK > 2
        ,&EE_oo_thread_stub      /* thread TzCtrl */
    #endif
    #if EE_MAX_TASK > 3
        ,&EE_oo_thread_stub      /* thread tsk_CyclicDispatcher */
    #endif
    #if EE_MAX_TASK > 4
        ,&EE_oo_thread_stub      /* thread tsk_EventDispatcher */
    #endif
    #if EE_MAX_TASK > 5
    ...
    #endif
    #if EE_MAX_TASK > 3
        ,&Functsk_CyclicDispatcher
    #endif
    #if EE_MAX_TASK > 4
        ,&Functsk_EventDispatcher
    #endif
    #if EE_MAX_TASK > 5
        ,&FuncTask_6
    #endif
    ...
    {
    #if EE_MAX_EVENT > 0
         "ev_targetspeedRequested_onUpdate"
    #endif
    #if EE_MAX_EVENT > 1
        ,"ev_targetspeed_onUpdate"
    #endif
    #if EE_MAX_EVENT > 2
        ,"ev_isr_protocolBufferComplete"
    #endif
    #if EE_MAX_EVENT > 3
         ,"ev_protocolTx_onUpdate"
    #endif
    #if EE_MAX_EVENT > 4
         ,"ev_protocolRx_onError"
    #endif
    #if EE_MAX_EVENT > 5
         ,"ev_joystick_onUpdate"
    #endif
    #if EE_MAX_EVENT > 6
         ,"ev_carstate_onUpdate"
    #endif
    #if EE_MAX_EVENT > 7
         ,"ev_event_rx_onUpdate"
    #endif
    #if EE_MAX_EVENT > 8
         ,"ev_event_tx_onUpdate"
    #endif
    #if EE_MAX_EVENT > 9
         ,"ev_ultrasonic_onError"
    #endif
    #if EE_MAX_EVENT > 10
         ,"Event_11"
    #endif
