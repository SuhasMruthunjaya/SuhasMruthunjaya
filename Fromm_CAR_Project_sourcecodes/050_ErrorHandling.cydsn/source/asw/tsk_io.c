...
const RTE_eventTable_t RTE_eventActivationTable_tsk_io[] = {
    ...
    { MONITOR_processDiagnosticRequest_run, ev_diagnosticrequest_onData },  //Received DIagnostic Request and processes it, e.g clears DETor transmits DET to client
}; 
