 ...
 * shortname: health
 * signalIN: so_joystick|so_targetspeed|so_currentspeed|so_controlspeed|so_protocolRx|so_protocolTx|so_carState|so_eventIn|so_eventOut|so_carErrorState
 ...
 * component: swc_monitor
 * cycletime: 0
 * description: Received DIagnostic Request and processes it, e.g clears DETor transmits DET to client
...
MONITOR_request_t MONITOR__checkEngine()
{
    ...
    //LOG_I("MEN_ENG_BLOCK", "RR CTRL %d CURR %d - err_i %d ", CONTROL_speed.m_rpm_rr, CURRENT_speed.m_rpm_rr, (int)e_rr);
    //LOG_I("MEN_ENG_BLOCK", "RR err_i %d RL err_i %d FR err_i %d FL err_i %d ", (int)e_rr, (int)e_rl, (int)e_fr, (int)e_fl);
    LOG_I("MEN_ENG_BLOCK", "FR CTRL %d CURR %d - err_i %d ", CONTROL_speed.m_rpm_fr, CURRENT_speed.m_rpm_fr, (int)e_fr);
