...
/**
 *  file    SC_DIAGNOSTICREQUEST_signal.h
 *
 *  brief   signal base class for signal sc_diagnosticrequest
 *
 *  author  Autogenerated, Peter Fromm       <peter.fromm@h-da.de>
 *
 * description: Diagnostic service request
 * name: sc_diagnosticRequest
...
#ifndef SC_DIAGNOSTICREQUEST_SIGNAL_H_INCLUDED
#define SC_DIAGNOSTICREQUEST_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*SC_DIAGNOSTICREQUEST_driverIn_t)(SC_DIAGNOSTICREQUEST_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*SC_DIAGNOSTICREQUEST_driverOut_t)( const SC_DIAGNOSTICREQUEST_data_t * const);
...
/**
 * Instances of the struct SC_DIAGNOSTICREQUEST_cfg_t represent the signal object configuration.
 */
struct SC_DIAGNOSTICREQUEST_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    SC_DIAGNOSTICREQUEST_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   SC_DIAGNOSTICREQUEST_driverOut_t const outDriver;
...
typedef const struct SC_DIAGNOSTICREQUEST_cfg_s SC_DIAGNOSTICREQUEST_cfg_t;
...
/**
 * Instances of the struct SC_DIAGNOSTICREQUEST_t represent the signal objects.
 * A signal object contains the current application value 'value' as well as relevant meta data.
 */
struct SC_DIAGNOSTICREQUEST_s
{                                                                                                                      

	/**
	 * Data buffer for the application value
	 */
    SC_DIAGNOSTICREQUEST_data_t value;
     ...
     */
	const SC_DIAGNOSTICREQUEST_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct SC_DIAGNOSTICREQUEST_s SC_DIAGNOSTICREQUEST_t;
 ...
 *
 * @param  SC_DIAGNOSTICREQUEST_t * const signal: Pointer to the signal object which will be initialised
 * @param const sc_diagnosticrequest_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_DIAGNOSTICREQUEST_init( SC_DIAGNOSTICREQUEST_t * const signal, const SC_DIAGNOSTICREQUEST_data_t * const value )
{                                                                                                                      
 ...
 *
 * @param  SC_DIAGNOSTICREQUEST_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_SC_DIAGNOSTICREQUEST_getStatus( const SC_DIAGNOSTICREQUEST_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_SC_DIAGNOSTICREQUEST_setStatus( SC_DIAGNOSTICREQUEST_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_SC_DIAGNOSTICREQUEST_getAge( const SC_DIAGNOSTICREQUEST_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_SC_DIAGNOSTICREQUEST_incAge(  SC_DIAGNOSTICREQUEST_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  SC_DIAGNOSTICREQUEST_t * const signal: Pointer to the signal object
 * @return sc_diagnosticrequest_data_t*: pointer to the current value of the application data buffer
 *
 **/
inline SC_DIAGNOSTICREQUEST_data_t* RTE_SC_DIAGNOSTICREQUEST_getPtr( SC_DIAGNOSTICREQUEST_t * const signal )
{               
 ...
 *
 * @param  SC_DIAGNOSTICREQUEST_t * const signal: Pointer to the signal object
 * @return sc_diagnosticrequest_data_t: current value of the application data buffer
 *
 **/
inline SC_DIAGNOSTICREQUEST_data_t RTE_SC_DIAGNOSTICREQUEST_get( const SC_DIAGNOSTICREQUEST_t * const signal )
{               
   //Todo: Critical region cannot be protected using return values																						
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  SC_DIAGNOSTICREQUEST_t * const signal: Pointer to the signal object
 * @param  SC_DIAGNOSTICREQUEST_data_t* data: Pointer to the return data Pointer to the signal object
 * @return RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_DIAGNOSTICREQUEST_getThreadSafe( const SC_DIAGNOSTICREQUEST_t * const signal, SC_DIAGNOSTICREQUEST_data_t * const data )
{    
 ...
 *
 * @param  SC_DIAGNOSTICREQUEST_t * const signal: Pointer to the signal object
 * @param  sc_diagnosticrequest_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_DIAGNOSTICREQUEST_set(SC_DIAGNOSTICREQUEST_t * const signal, const SC_DIAGNOSTICREQUEST_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_SC_DIAGNOSTICREQUEST_pullPort( SC_DIAGNOSTICREQUEST_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {
	  SC_DIAGNOSTICREQUEST_data_t value = signal->value;
      ret = signal->pSigCfg->inDriver(&value);
                                                                                                                       
      if ( ret == RC_SUCCESS )                                                                                         
      {
    	  //Critical Section
    	  RTE_SC_DIAGNOSTICREQUEST_set(signal, value);
      }
      else
      {
		  //Signal is invalid. Error event (if present) will be fired
		  RTE_SC_DIAGNOSTICREQUEST_setStatus(signal, RTE_SIGNALSTATUS_INVALID);
      }
 ...
 *
 **/
inline RC_t RTE_SC_DIAGNOSTICREQUEST_pushPort( const SC_DIAGNOSTICREQUEST_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
