...
#if (Number_of_ISRs > 1) && defined isr_uart_usb__INTC_NUMBER
    ramVectorTable[CY_INT_IRQ_BASE + (isr_uart_usb__INTC_NUMBER & CY_INT_NUMBER_MASK)] = isr_uart_usb;
	//PF v2.5.3
    //NVIC_SET_PRI(isr_uart_usb__INTC_NUMBER, (ISR_MIN_PRI - 5));
    CyIntSetPriority(isr_uart_usb__INTC_NUMBER, ISR_SCALE(5));
    //\PF
