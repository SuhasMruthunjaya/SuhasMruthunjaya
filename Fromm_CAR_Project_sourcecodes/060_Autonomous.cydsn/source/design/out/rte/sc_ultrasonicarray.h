...
/**
 *  file    SC_ULTRASONICARRAY_signal.h
 *
 *  brief   signal base class for signal sc_ultrasonicarray
 *
...
#ifndef SC_ULTRASONICARRAY_SIGNAL_H_INCLUDED
#define SC_ULTRASONICARRAY_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*SC_ULTRASONICARRAY_driverIn_t)(SC_ULTRASONICARRAY_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*SC_ULTRASONICARRAY_driverOut_t)( const SC_ULTRASONICARRAY_data_t * const);
...
/**
 * Instances of the struct SC_ULTRASONICARRAY_cfg_t represent the signal object configuration.
 */
struct SC_ULTRASONICARRAY_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    SC_ULTRASONICARRAY_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   SC_ULTRASONICARRAY_driverOut_t const outDriver;
...
typedef const struct SC_ULTRASONICARRAY_cfg_s SC_ULTRASONICARRAY_cfg_t;
...
/**
 * Instances of the struct SC_ULTRASONICARRAY_t represent the signal objects.
 * A signal object contains the current application value 'value' as well as relevant meta data.
 */
struct SC_ULTRASONICARRAY_s
{                                                                                                                      

	/**
	 * Data buffer for the application value
	 */
    SC_ULTRASONICARRAY_data_t value;
     ...
     */
	const SC_ULTRASONICARRAY_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct SC_ULTRASONICARRAY_s SC_ULTRASONICARRAY_t;
 ...
 *
 * @param  SC_ULTRASONICARRAY_t * const signal: Pointer to the signal object which will be initialised
 * @param const sc_ultrasonicarray_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_ULTRASONICARRAY_init( SC_ULTRASONICARRAY_t * const signal, const SC_ULTRASONICARRAY_data_t * const value )
{                                                                                                                      
 ...
 *
 * @param  SC_ULTRASONICARRAY_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_SC_ULTRASONICARRAY_getStatus( const SC_ULTRASONICARRAY_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_SC_ULTRASONICARRAY_setStatus( SC_ULTRASONICARRAY_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_SC_ULTRASONICARRAY_getAge( const SC_ULTRASONICARRAY_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_SC_ULTRASONICARRAY_incAge(  SC_ULTRASONICARRAY_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  SC_ULTRASONICARRAY_t * const signal: Pointer to the signal object
 * @return sc_ultrasonicarray_data_t*: pointer to the current value of the application data buffer
 *
 **/
inline SC_ULTRASONICARRAY_data_t* RTE_SC_ULTRASONICARRAY_getPtr( SC_ULTRASONICARRAY_t * const signal )
{               
 ...
 *
 * @param  SC_ULTRASONICARRAY_t * const signal: Pointer to the signal object
 * @return sc_ultrasonicarray_data_t: current value of the application data buffer
 *
 **/
inline SC_ULTRASONICARRAY_data_t RTE_SC_ULTRASONICARRAY_get( const SC_ULTRASONICARRAY_t * const signal )
{               
   //Todo: Critical region cannot be protected using return values																						
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  SC_ULTRASONICARRAY_t * const signal: Pointer to the signal object
 * @param  SC_ULTRASONICARRAY_data_t* data: Pointer to the return data Pointer to the signal object
 * @return RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_ULTRASONICARRAY_getThreadSafe( const SC_ULTRASONICARRAY_t * const signal, SC_ULTRASONICARRAY_data_t * const data )
{    
 ...
 *
 * @param  SC_ULTRASONICARRAY_t * const signal: Pointer to the signal object
 * @param  sc_ultrasonicarray_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_ULTRASONICARRAY_set(SC_ULTRASONICARRAY_t * const signal, const SC_ULTRASONICARRAY_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_SC_ULTRASONICARRAY_pullPort( SC_ULTRASONICARRAY_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {
	  SC_ULTRASONICARRAY_data_t value = signal->value;
      ret = signal->pSigCfg->inDriver(&value);
                                                                                                                       
      if ( ret == RC_SUCCESS )                                                                                         
      {
    	  //Critical Section
    	  RTE_SC_ULTRASONICARRAY_set(signal, value);
      }
      else
      {
		  //Signal is invalid. Error event (if present) will be fired
		  RTE_SC_ULTRASONICARRAY_setStatus(signal, RTE_SIGNALSTATUS_INVALID);
      }
 ...
 *
 **/
inline RC_t RTE_SC_ULTRASONICARRAY_pushPort( const SC_ULTRASONICARRAY_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
