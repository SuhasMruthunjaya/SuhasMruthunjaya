...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48001260u)
...
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x4800127Cu)

/* IOPINS0_3 Address: CYREG_PRT3_DR Size (bytes): 10 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48001284u)
