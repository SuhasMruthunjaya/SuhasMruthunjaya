...
/**
 *  file    SC_EVENT_OUT_signal.h
 *
 *  brief   signal base class for signal sc_event_out
 *
...
#ifndef SC_EVENT_OUT_SIGNAL_H_INCLUDED
#define SC_EVENT_OUT_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*SC_EVENT_OUT_driverIn_t)(SC_EVENT_OUT_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*SC_EVENT_OUT_driverOut_t)( const SC_EVENT_OUT_data_t * const);
...
/**
 * Instances of the struct SC_EVENT_OUT_cfg_t represent the signal object configuration.
 */
struct SC_EVENT_OUT_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    SC_EVENT_OUT_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   SC_EVENT_OUT_driverOut_t const outDriver;
...
typedef const struct SC_EVENT_OUT_cfg_s SC_EVENT_OUT_cfg_t;
...
{                                                                                                                      
     ...
     */
	const SC_EVENT_OUT_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct SC_EVENT_OUT_s SC_EVENT_OUT_t;
 ...
 *
 * @param  SC_EVENT_OUT_t * const signal: Pointer to the signal object which will be initialised
 * @param const sc_event_out_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_EVENT_OUT_init( SC_EVENT_OUT_t * const signal, const SC_EVENT_OUT_data_t * const value )
{                                                                                                                      
 ...
 *
 * @param  SC_EVENT_OUT_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_SC_EVENT_OUT_getStatus( const SC_EVENT_OUT_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_SC_EVENT_OUT_setStatus( SC_EVENT_OUT_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_SC_EVENT_OUT_getAge( const SC_EVENT_OUT_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_SC_EVENT_OUT_incAge(  SC_EVENT_OUT_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  SC_EVENT_OUT_t * const signal: Pointer to the signal object
 * @return sc_event_out_data_t*: pointer to the current value of the application data buffer
 *
 **/
inline SC_EVENT_OUT_data_t* RTE_SC_EVENT_OUT_getPtr( SC_EVENT_OUT_t * const signal )
{               
 ...
 *
 * @param  SC_EVENT_OUT_t * const signal: Pointer to the signal object
 * @return sc_event_out_data_t: current value of the application data buffer
 *
 **/
inline SC_EVENT_OUT_data_t RTE_SC_EVENT_OUT_get( const SC_EVENT_OUT_t * const signal )
{               
   //Todo: Critical region cannot be protected using return values																						
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  SC_EVENT_OUT_t * const signal: Pointer to the signal object
 * @param  SC_EVENT_OUT_data_t* data: Pointer to the return data Pointer to the signal object
 * @return RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_EVENT_OUT_getThreadSafe( const SC_EVENT_OUT_t * const signal, SC_EVENT_OUT_data_t * const data )
{    
 ...
 *
 * @param  SC_EVENT_OUT_t * const signal: Pointer to the signal object
 * @param  sc_event_out_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_EVENT_OUT_set(SC_EVENT_OUT_t * const signal, const SC_EVENT_OUT_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_SC_EVENT_OUT_pullPort( SC_EVENT_OUT_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {
	  SC_EVENT_OUT_data_t value = signal->value;
      ret = signal->pSigCfg->inDriver(&value);
                                                                                                                       
      if ( ret == RC_SUCCESS )                                                                                         
      {
    	  //Critical Section
    	  RTE_SC_EVENT_OUT_set(signal, value);
      }
      else
      {
		  //Signal is invalid. Error event (if present) will be fired
		  RTE_SC_EVENT_OUT_setStatus(signal, RTE_SIGNALSTATUS_INVALID);
      }
 ...
 *
 **/
inline RC_t RTE_SC_EVENT_OUT_pushPort( const SC_EVENT_OUT_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
