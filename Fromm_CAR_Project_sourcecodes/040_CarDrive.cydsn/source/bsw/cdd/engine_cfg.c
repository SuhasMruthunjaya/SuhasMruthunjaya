...
#define ENG_MAXRPM          250     //Physical max value
...
static RC_t ENG__setPwm_RR(sint32_t pwm_value)
{
    ...
    Engine_PWM_Rear_WriteCompare1(new_pwm);
}
...
static RC_t ENG__setPwm_RL(sint32_t pwm_value)
{
    ...
    Engine_PWM_Rear_WriteCompare2(new_pwm);
...
static RC_t ENG__setPwm_FR(sint32_t pwm_value)
{
    ...
    Engine_PWM_Front_WriteCompare1(new_pwm);
}
...
static RC_t ENG__setPwm_FL(sint32_t pwm_value)
{
    ...
    Engine_PWM_Front_WriteCompare2(new_pwm);
}
