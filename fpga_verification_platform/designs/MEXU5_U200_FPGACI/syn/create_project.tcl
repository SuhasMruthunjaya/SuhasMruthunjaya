...
set PROJECT_NAME MEXU5_U200_FPGACI
...
add_files -norecurse -fileset sources_1 [subst {$ROOT_FOLDER/designs/$PROJECT_NAME/rtl/Mercury_XU5_FPGACI.vhd}]
add_files -norecurse -fileset constrs_1 [subst {$ROOT_FOLDER/designs/$PROJECT_NAME/syn/constraints/Mercury_XU5_FPGACI.tcl}]
...
# ################################################
source $ROOT_FOLDER/designs/$PROJECT_NAME/syn/MEXU5_U200_FPGACI_bd.tcl
# ################################################
