...
set_property -dict {PACKAGE_PIN F10 IOSTANDARD LVCMOS33} [get_ports PHX_CS_N_A1]
set_property -dict {PACKAGE_PIN D11 IOSTANDARD LVCMOS33} [get_ports PHX_SCLK_A1]
set_property -dict {PACKAGE_PIN E10 IOSTANDARD LVCMOS33} [get_ports PHX_RSCLK_A1]
set_property -dict {PACKAGE_PIN A10 IOSTANDARD LVCMOS33} [get_ports PHU_SDO_A1]
set_property -dict {PACKAGE_PIN B10 IOSTANDARD LVCMOS33} [get_ports PHV_SDO_A1]
set_property -dict {PACKAGE_PIN D10 IOSTANDARD LVCMOS33} [get_ports PHW_SDO_A1]
####### Inverter Interface #######
set_property -dict {PACKAGE_PIN E13 IOSTANDARD LVCMOS33} [get_ports GATE_UT_A1]
set_property -dict {PACKAGE_PIN H12 IOSTANDARD LVCMOS33} [get_ports GATE_UB_A1]
set_property -dict {PACKAGE_PIN G11 IOSTANDARD LVCMOS33} [get_ports GATE_VT_A1]
set_property -dict {PACKAGE_PIN H11 IOSTANDARD LVCMOS33} [get_ports GATE_VB_A1]
set_property -dict {PACKAGE_PIN G13 IOSTANDARD LVCMOS33} [get_ports GATE_WT_A1]
set_property -dict {PACKAGE_PIN J11 IOSTANDARD LVCMOS33} [get_ports GATE_WB_A1]
set_property -dict {PACKAGE_PIN J10 IOSTANDARD LVCMOS33} [get_ports GATE_FLT_A1]
####### LEDs #######
set_property -dict {PACKAGE_PIN AB14 IOSTANDARD LVCMOS33} [get_ports LED4_GR]
set_property -dict {PACKAGE_PIN AB15 IOSTANDARD LVCMOS33} [get_ports LED4_RD]
####### PL UART Interface #######
set_property -dict {PACKAGE_PIN AF1 IOSTANDARD LVCMOS18} [get_ports UART2_TX]
set_property -dict {PACKAGE_PIN AG1 IOSTANDARD LVCMOS18} [get_ports UART2_RX]
###################### Debug Interface ######################
####### LVDS Debug Pins #######
