...
*/
enum eLED_id{
  LED_1,        /**< Selection of LED 1 */
  LED_2,        /**< Selection of LED 2 */
  LED_3,        /**< Selection of LED 3 */
  LED_4,        /**< Selection of LED 4 */
...
enum eLED_ONOFF{
    ...
    LED_TOGGLE = 2  /**< Make LED toggle */
};
typedef enum eLED_ONOFF LED_mode_t;
