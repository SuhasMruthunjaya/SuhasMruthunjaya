...
/*****************************************************************************/
    ...
    //Decoder parameters
    #define ENG_ENGINE_RATIO    34      //Documentation said 34, but measurement something else...
    #define ENG_DECODER_RATIO   10
    
    //Engine open loop parameters
    #define ENG_MAXRPM          180
    #define ENG_MINRPM          20
    #define ENG_MAXREVERSERPM   -100
    #define ENG_PWMSTART        1100    //To overcome the holding torque
    #define ENG_PWMMIN          2000    //To avoid peeping
