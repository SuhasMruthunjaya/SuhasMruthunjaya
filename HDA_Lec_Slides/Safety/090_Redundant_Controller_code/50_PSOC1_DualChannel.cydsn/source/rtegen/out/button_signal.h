/**
*  file    BUTTON_signal.h
*
*  brief   signal base class for signal button
*
...
#ifndef BUTTON_SIGNAL_H_INCLUDED
#define BUTTON_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*BUTTON_driverIn_t)(BUTTON_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*BUTTON_driverOut_t)( const BUTTON_data_t * const);
...
/**
 * Instances of the struct BUTTON_cfg_t represent the signal object configuration.
 */
struct BUTTON_cfg_s
{
    /**
     ...
     */
    BUTTON_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   BUTTON_driverOut_t const outDriver;
...
typedef const struct BUTTON_cfg_s BUTTON_cfg_t;
...
/**
 * Instances of the struct BUTTON_t represent the signal objects.
...
{                                                                                                                      
     ...
     */
	const BUTTON_cfg_t * const    pSigCfg;
 ...
 *
 * @param  BUTTON_t * const signal: Pointer to the signal object which will be initialised
 * @param const button_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_BUTTON_init( BUTTON_t * const signal, const BUTTON_data_t * const value )
{                                                                                                                      
 ...
 *
 * @param  BUTTON_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_BUTTON_getStatus( const BUTTON_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_BUTTON_setStatus( BUTTON_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_BUTTON_getAge( const BUTTON_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_BUTTON_incAge(  BUTTON_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  BUTTON_t * const signal: Pointer to the signal object
 * @return button_data_t: current value of the application data buffer
 *
 **/
inline BUTTON_data_t RTE_BUTTON_get( const BUTTON_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  BUTTON_t * const signal: Pointer to the signal object
 * @param  button_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_BUTTON_set(BUTTON_t * const signal, const BUTTON_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_BUTTON_pullPort( BUTTON_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {
	  BUTTON_data_t value = signal->value;
      ret = signal->pSigCfg->inDriver(&value);
                                                                                                                       
      if ( ret == RC_SUCCESS )                                                                                         
      {
    	  //Critical Section
    	  RTE_BUTTON_set(signal, value);
      }
      else
      {
    	  //Set the status and fire error event if available
    	  RTE_BUTTON_setStatus( signal, RTE_SIGNALSTATUS_INVALID );
 ...
 *
 **/
inline RC_t RTE_BUTTON_pushPort( const BUTTON_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
