/**
*  file    DRIVINGPARAM_signal.h
*
*  brief   signal base class for signal drivingParam
*
...
#ifndef DRIVINGPARAM_SIGNAL_H_INCLUDED
#define DRIVINGPARAM_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*DRIVINGPARAM_driverIn_t)(DRIVINGPARAM_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*DRIVINGPARAM_driverOut_t)( const DRIVINGPARAM_data_t * const);
...
/**
 * Instances of the struct DRIVINGPARAM_cfg_t represent the signal object configuration.
 */
struct DRIVINGPARAM_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    DRIVINGPARAM_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   DRIVINGPARAM_driverOut_t const outDriver;
...
typedef const struct DRIVINGPARAM_cfg_s DRIVINGPARAM_cfg_t;
...
{                                                                                                                      
     ...
     */
	const DRIVINGPARAM_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct DRIVINGPARAM_s DRIVINGPARAM_t;
 ...
 *
 * @param  DRIVINGPARAM_t * const signal: Pointer to the signal object which will be initialised
 * @param const drivingParam_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_DRIVINGPARAM_init( DRIVINGPARAM_t * const signal, const DRIVINGPARAM_data_t * const value )
{                                                                                                                      
 ...
 *
 * @param  DRIVINGPARAM_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_DRIVINGPARAM_getStatus( const DRIVINGPARAM_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_DRIVINGPARAM_setStatus( DRIVINGPARAM_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_DRIVINGPARAM_getAge( const DRIVINGPARAM_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_DRIVINGPARAM_incAge(  DRIVINGPARAM_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  DRIVINGPARAM_t * const signal: Pointer to the signal object
 * @return drivingParam_data_t: current value of the application data buffer
 *
 **/
inline DRIVINGPARAM_data_t RTE_DRIVINGPARAM_get( const DRIVINGPARAM_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  DRIVINGPARAM_t * const signal: Pointer to the signal object
 * @param  drivingParam_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_DRIVINGPARAM_set(DRIVINGPARAM_t * const signal, const DRIVINGPARAM_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_DRIVINGPARAM_pullPort( DRIVINGPARAM_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {
	  DRIVINGPARAM_data_t value = signal->value;
      ret = signal->pSigCfg->inDriver(&value);
                                                                                                                       
      if ( ret == RC_SUCCESS )                                                                                         
      {
    	  //Critical Section
    	  RTE_DRIVINGPARAM_set(signal, value);
      }
      else
      {
    	  //Set the status and fire error event if available
    	  RTE_DRIVINGPARAM_setStatus( signal, RTE_SIGNALSTATUS_INVALID );
 ...
 *
 **/
inline RC_t RTE_DRIVINGPARAM_pushPort( const DRIVINGPARAM_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
