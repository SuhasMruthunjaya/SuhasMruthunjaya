...
#ifndef CARSTATE_SIGNAL_H_INCLUDED
#define CARSTATE_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*CARSTATE_driverIn_t)(CARSTATE_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*CARSTATE_driverOut_t)( const CARSTATE_data_t * const);
...
/**
 * Instances of the struct CARSTATE_cfg_t represent the signal object configuration.
 */
struct CARSTATE_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    CARSTATE_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   CARSTATE_driverOut_t const outDriver;
...
typedef const struct CARSTATE_cfg_s CARSTATE_cfg_t;
...
{                                                                                                                      
     ...
     */
	const CARSTATE_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct CARSTATE_s CARSTATE_t;
 ...
 * @param const carState_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_CARSTATE_init( CARSTATE_t * const signal, const CARSTATE_data_t * const value )
{                                                                                                                      
 ...
 *
 **/
inline RTE_signalStatus_t RTE_CARSTATE_getStatus( const CARSTATE_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_CARSTATE_setStatus( CARSTATE_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_CARSTATE_getAge( const CARSTATE_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_CARSTATE_incAge(  CARSTATE_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 **/
inline CARSTATE_data_t RTE_CARSTATE_get( const CARSTATE_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 **/
inline RC_t RTE_CARSTATE_set(CARSTATE_t * const signal, const CARSTATE_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_CARSTATE_pullPort( CARSTATE_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {
	  CARSTATE_data_t value = signal->value;
      ret = signal->pSigCfg->inDriver(&value);
                                                                                                                       
      if ( ret == RC_SUCCESS )                                                                                         
      {
    	  //Critical Section
    	  RTE_CARSTATE_set(signal, value);
      }
      else
      {
    	  //Set the status and fire error event if available
    	  RTE_CARSTATE_setStatus( signal, RTE_SIGNALSTATUS_INVALID );
 ...
 *
 **/
inline RC_t RTE_CARSTATE_pushPort( const CARSTATE_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
