...
*  file    LED_signal.h
*
*  brief   signal base class for signal led
*
...
#ifndef LED_SIGNAL_H_INCLUDED
#define LED_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*LED_driverIn_t)(LED_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*LED_driverOut_t)( const LED_data_t * const);
...
/**
 * Instances of the struct LED_cfg_t represent the signal object configuration.
 */
struct LED_cfg_s
{
    /**
     ...
     */
    LED_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   LED_driverOut_t const outDriver;
...
typedef const struct LED_cfg_s LED_cfg_t;
...
/**
 * Instances of the struct LED_t represent the signal objects.
 ...
 *
 * @param  LED_t * const signal: Pointer to the signal object which will be initialised
 * @param const led_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_LED_init( LED_t * const signal, const LED_data_t * const value )
{                                                                                                                      
 ...
 *
 * @param  LED_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_LED_getStatus( const LED_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_LED_setStatus( LED_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_LED_getAge( const LED_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_LED_incAge(  LED_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  LED_t * const signal: Pointer to the signal object
 * @return led_data_t: current value of the application data buffer
 *
 **/
inline LED_data_t RTE_LED_get( const LED_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  LED_t * const signal: Pointer to the signal object
 * @param  led_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_LED_set(LED_t * const signal, const LED_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_LED_pullPort( LED_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {
	  LED_data_t value = signal->value;
      ret = signal->pSigCfg->inDriver(&value);
                                                                                                                       
      if ( ret == RC_SUCCESS )                                                                                         
      {
    	  //Critical Section
    	  RTE_LED_set(signal, value);
      }
      else
      {
    	  //Set the status and fire error event if available
    	  RTE_LED_setStatus( signal, RTE_SIGNALSTATUS_INVALID );
 ...
 *
 **/
inline RC_t RTE_LED_pushPort( const LED_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
