/**
*  file    UARTPROT_signal.h
*
*  brief   signal base class for signal uartprot
*
...
#ifndef UARTPROT_SIGNAL_H_INCLUDED
#define UARTPROT_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*UARTPROT_driverIn_t)(UARTPROT_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*UARTPROT_driverOut_t)( const UARTPROT_data_t * const);
...
/**
 * Instances of the struct UARTPROT_cfg_t represent the signal object configuration.
 */
struct UARTPROT_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    UARTPROT_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   UARTPROT_driverOut_t const outDriver;
...
typedef const struct UARTPROT_cfg_s UARTPROT_cfg_t;
...
/**
 * Instances of the struct UARTPROT_t represent the signal objects.
...
{                                                                                                                      
     ...
     */
	const UARTPROT_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct UARTPROT_s UARTPROT_t;
 ...
 *
 * @param  UARTPROT_t * const signal: Pointer to the signal object which will be initialised
 * @param const uartprot_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_UARTPROT_init( UARTPROT_t * const signal, const UARTPROT_data_t * const value )
{                                                                                                                      
 ...
 *
 * @param  UARTPROT_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_UARTPROT_getStatus( const UARTPROT_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_UARTPROT_setStatus( UARTPROT_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_UARTPROT_getAge( const UARTPROT_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_UARTPROT_incAge(  UARTPROT_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  UARTPROT_t * const signal: Pointer to the signal object
 * @return uartprot_data_t: current value of the application data buffer
 *
 **/
inline UARTPROT_data_t RTE_UARTPROT_get( const UARTPROT_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  UARTPROT_t * const signal: Pointer to the signal object
 * @param  uartprot_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_UARTPROT_set(UARTPROT_t * const signal, const UARTPROT_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_UARTPROT_pullPort( UARTPROT_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {
	  UARTPROT_data_t value = signal->value;
      ret = signal->pSigCfg->inDriver(&value);
                                                                                                                       
      if ( ret == RC_SUCCESS )                                                                                         
      {
    	  //Critical Section
    	  RTE_UARTPROT_set(signal, value);
      }
      else
      {
    	  //Set the status and fire error event if available
    	  RTE_UARTPROT_setStatus( signal, RTE_SIGNALSTATUS_INVALID );
 ...
 *
 **/
inline RC_t RTE_UARTPROT_pushPort( const UARTPROT_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
