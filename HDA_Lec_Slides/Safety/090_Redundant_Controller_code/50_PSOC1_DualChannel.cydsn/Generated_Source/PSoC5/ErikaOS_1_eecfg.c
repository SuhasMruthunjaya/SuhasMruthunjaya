 ...
 **************************************************************************/
    ...
    #define TASK_5_STACK_SIZE 1200/4 // size = 1200 bytes
    ...
    #if 1
    #define IRQ_STACK_SIZE    1200/4 // size = 1200 bytes
 ...
 **************************************************************************/
    ...
    {
    #if EE_MAX_EVENT > 0
         "ev_pedalPosition_onError"
    #endif
    #if EE_MAX_EVENT > 1
        ,"ev_controlSpeed_onError"
    #endif
    #if EE_MAX_EVENT > 2
        ,"ev_currentSpeed_onError"
    #endif
    #if EE_MAX_EVENT > 3
         ,"ev_event_onUpdate"
    #endif
    #if EE_MAX_EVENT > 4
         ,"ev_drivingParam_onUpdate"
    #endif
    #if EE_MAX_EVENT > 5
         ,"ev_uartIsr_onUpdate"
    #endif
