...
* \date 18.2.20
*
* \brief Testcases for the Safety Board
*
...
typedef void (*BT_run_t)(void);

typedef struct
{
    BT_run_t run;   /**< Pointer to the testfunction */
    uint16_t t;     /**< Time in ms */
} BT_testcase_t;
...
/**
 * Init additional peripherals used for the boardtest
 * @return RC_SUCCESS or error code
 */
