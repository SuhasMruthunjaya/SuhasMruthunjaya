...
#if (Number_of_ISRs > 1) && defined I2C_I2C_IRQ__INTC_NUMBER
    ramVectorTable[CY_INT_IRQ_BASE + (I2C_I2C_IRQ__INTC_NUMBER & CY_INT_NUMBER_MASK)] = I2C_I2C_IRQ;
	NVIC_SET_PRI(I2C_I2C_IRQ__INTC_NUMBER, (ISR_MIN_PRI - 7));
	NVIC_INT_ENABLE(I2C_I2C_IRQ__INTC_NUMBER);
#elif Number_of_ISRs > 1
#error  The Interrupt I2C_I2C_IRQ could not be found. Make sure the name in the OS config exactly matches the name of the interrupt in the interrupt tab.
#endif	/* I2C_I2C_IRQ */
