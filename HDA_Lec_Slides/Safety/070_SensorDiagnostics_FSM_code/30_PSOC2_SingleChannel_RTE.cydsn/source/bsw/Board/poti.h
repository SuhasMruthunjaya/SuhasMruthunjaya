...
* \date 29.8.17
*
* \brief Driver for the Joystick / Potentiometer
*
* Driver for reading the Joystick / Potentiometer
*
* \note <notes>
...
/**
 * Potentiometer Channels, mapped to input 1..3 of the SAR
 */
typedef enum POTI_channel{POTI_1, POTI_2, POTI_3} POTI_channel_t;
 ...
 * @param uint16_t* pos - position of the potentiometer 0...255
 * @return RC_SUCCESS if all ok
 */
RC_t POTI_ReadPosition(POTI_channel_t channel, uint8_t* pos);
