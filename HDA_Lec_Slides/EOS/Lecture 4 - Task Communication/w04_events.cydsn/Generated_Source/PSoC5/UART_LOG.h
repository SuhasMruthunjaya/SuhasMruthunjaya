...
#define UART_LOG_RX_INTERRUPT_ENABLED           (1u)
...
#define UART_LOG_TX_BUFFER_SIZE                 (1924u)
#define UART_LOG_RX_BUFFER_SIZE                 (256u)
...
/* Only if RX is enabled */
    ...
    uint16 UART_LOG_GetRxBufferSize(void)
                                                            ;
...
extern uint8 UART_LOG_initVar;
    ...
    extern volatile uint16 UART_LOG_rxBufferRead;
    extern volatile uint16 UART_LOG_rxBufferWrite;
