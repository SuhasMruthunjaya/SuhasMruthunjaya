...
* \date 6.11.18
*
* \brief A simple PWM Sound Driver
*
...
*/
 enum eSOUND_Channel{
    SOUND_OFF = 0,      /**< All Channel off */
    SOUND_CH1 = 1,      /**< Input Channel 1 */
    SOUND_CH2 = 2,      /**< Input Channel 2 */
    SOUND_CH3 = 3,      /**< Input Channel 3 */
} ;
typedef enum eSOUND_Channel SOUND_Channel_t;
