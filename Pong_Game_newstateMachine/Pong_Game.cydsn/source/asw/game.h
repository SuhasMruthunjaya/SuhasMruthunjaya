...
*/
 ...
 enum BallSituation{
    BALL_UNKNOWN,
  BALL_ISNOTMISSING,
  BALL_ISMISSING,  /**< Some documentation first. */
    /**< Some documentation second. */
} ;
typedef enum BallSituation Ball_Situation_t;
...
*/
struct sGame {
    GAME_Enum_t selection;
    GAME_State_t state;
    sint8_t life;//Todo check if here or in pong or soccer object
    sint8_t score;
    uint32_t time;
    GAME_event_t ev;
    Ball_Situation_t BallSituation;
 ...
 * @return <return description>
 */
RC_t GAME_reset_time();
/**
 * <Description>
 * @param <Format: copy of the parameter type and name - description>
 * @return <return description>
 */
RC_t GAME_increment_time(uint32_t delta);
