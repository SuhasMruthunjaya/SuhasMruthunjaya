...
typedef struct
{
    const STATE_stateOuterTransitionTable_t* p_TransitionTable;
    const STATE_stateActionTable_t* p_ActionTable;
    const uint16_t* size_TransitionTable;
    const uint16_t* size_ActionTable;
    CLOCK_STATE_data_t state;
}FSM_t;
