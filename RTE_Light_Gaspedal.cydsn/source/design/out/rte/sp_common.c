...
/*
 * description: Joystick x,y for controlling the engine speed 
 * indriver: default
 * name: so_joystick
 * onDataError: 0
...
/* signal configuration */
/*
 * description: Speed calculated from the joystick x.y inputs
 * indriver: 0
...
/* signal configuration */
/*
 * description: The PWM signal output from the setspeed runnable which drives the RGB Led
 * indriver: 0
 * name: so_rgb_led
 * onDataError: 0
 * onDataUpdate: 0
...
/* signal configuration */
/*
 * description: The GPIO output coming from setbreaklight runnable which drives the Red LED.
 * indriver: 0
 * name: so_breaklight
 * onDataError: 0
 * onDataUpdate: 0
...
static const SC_BRAKELIGHT_cfg_t SO_BREAKLIGHT_cfg = 
{
   /* indriver           */  0,
...
SC_BRAKELIGHT_t SO_BREAKLIGHT_signal= 
{
...
void RTE_timertick_sp_common_tick(uint32_t tick){
   ...
   RTE_SC_BRAKELIGHT_incAge( &SO_BREAKLIGHT_signal, tick); 
...
void RTE_reset_sp_common(){
   ...
   RTE_SC_BRAKELIGHT_init( &SO_BREAKLIGHT_signal); 
