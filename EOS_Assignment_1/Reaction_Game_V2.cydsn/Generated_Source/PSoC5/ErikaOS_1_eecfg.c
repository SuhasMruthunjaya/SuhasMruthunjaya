 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_2[TASK_2_STACK_SIZE];	/* Task 2 (tsk_ledRedBlink) */
    #endif
    ...
    #define TASK_4_STACK_SIZE 400/4 // size = 400 bytes
    int EE_cortex_mx_stack_4[TASK_4_STACK_SIZE];	/* Task 4 (tsk_ReactionGame) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 4))
    #define TASK_5_STACK_SIZE 400/4 // size = 400 bytes
    int EE_cortex_mx_stack_5[TASK_5_STACK_SIZE];	/* Task 5 (tsk_reactiontime) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 5))
    #define TASK_6_STACK_SIZE 400/4 // size = 400 bytes
    int EE_cortex_mx_stack_6[TASK_6_STACK_SIZE];	/* Task 6 (tsk_rgb) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 6))
    #define TASK_7_STACK_SIZE 0/4 // size = 0 bytes
    int EE_cortex_mx_stack_7[TASK_7_STACK_SIZE];	/* Task 7 (tsk_seven_segment_display_wait) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 7))
    #define TASK_8_STACK_SIZE 0/4 // size = 0 bytes
    int EE_cortex_mx_stack_8[TASK_8_STACK_SIZE];	/* Task 8 (tsk_seven_segment_display_wait) */
    #endif
    ...
    #endif
    #if EE_MAX_TASK > 1
        ,Tsk2	 /* tsk_ledRedBlink*/
    #endif
    #if EE_MAX_TASK > 2
        ,Tsk3	 /* tsk_background*/
    #endif
    #if EE_MAX_TASK > 3
        ,Tsk4	 /* tsk_ReactionGame*/
    #endif
    #if EE_MAX_TASK > 4
        ,Tsk5	 /* tsk_reactiontime*/
    #endif
    #if EE_MAX_TASK > 5
        ,Tsk6	 /* tsk_rgb*/
    #endif
    #if EE_MAX_TASK > 6
        ,Tsk7 	 /* tsk_seven_segment_display_wait*/
    #endif
    #if EE_MAX_TASK > 7
        ,Tsk8      /* tsk_seven_segment_display_wait*/
    #endif
    };
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_2_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_2[(TASK_2_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}	/* tsk_ledRedBlink*/
        #endif
        #ifdef TASK_3_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_3[(TASK_3_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])} 	/* tsk_background*/
        #endif
        #ifdef TASK_4_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_4[(TASK_4_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_ReactionGame*/
        #endif
        #ifdef TASK_5_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_5[(TASK_5_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_reactiontime*/
        #endif
        #ifdef TASK_6_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_6[(TASK_6_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_rgb*/
        #endif
        #ifdef TASK_7_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_7[(TASK_7_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_seven_segment_display_wait*/
        #endif
        #ifdef TASK_8_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_8[(TASK_8_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_seven_segment_display_wait*/
        #endif
    };
 ...
 **************************************************************************/
    ...
    #endif
    #if EE_MAX_TASK > 4
    DeclareTask(tsk_reactiontime);
    #endif
    #if EE_MAX_TASK > 5
    DeclareTask(tsk_rgb);
    #endif
    #if EE_MAX_TASK > 6
    DeclareTask(tsk_seven_segment_display_wait);
    #endif
    #if EE_MAX_TASK > 7
    DeclareTask(tsk_seven_segment_display_wait);
    #endif
    ...
    #endif
    #if EE_MAX_TASK > 1
        ,&EE_oo_thread_stub      /* thread tsk_ledRedBlink */
    #endif
    #if EE_MAX_TASK > 2
    ...
    #endif
    #if EE_MAX_TASK > 4
        ,&EE_oo_thread_stub      /* thread tsk_reactiontime */
    #endif
    #if EE_MAX_TASK > 5
        ,&EE_oo_thread_stub      /* thread tsk_rgb */
    #endif
    #if EE_MAX_TASK > 6
        ,&EE_oo_thread_stub      /* thread tsk_seven_segment_display_wait */
    #endif
    #if EE_MAX_TASK > 7      
        ,&EE_oo_thread_stub      /* thread tsk_seven_segment_display_wait */
    #endif
    ...
    #endif
    #if EE_MAX_TASK > 4
        ,&Functsk_reactiontime
    #endif
    #if EE_MAX_TASK > 5
        ,&Functsk_rgb
    #endif
    #if EE_MAX_TASK > 6
        ,&Functsk_seven_segment_display_wait
    #endif
    #if EE_MAX_TASK > 7      
        ,&Functsk_seven_segment_display_wait
    #endif
    ...
    #endif
    #if EE_MAX_TASK > 6
        ,"tsk_seven_segment_display_wait"
    #endif
    #if EE_MAX_TASK > 7      
        ,"tsk_seven_segment_display_wait"
    #endif
 ...
 **************************************************************************/
    ...
    const EE_oo_counter_object_ROM_type   EE_oo_counter_object_ROM[EE_COUNTER_OBJECTS_ROM_SIZE] = {
        #if EE_MAX_ALARM > 0
        {0, alarm_ledRedblink, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 1
        ,{0, alarm_count, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 2
        ,{0, alarm_rgb, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 3
        ,{0, alarm_seven_seg_display_wait, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 4
        ,{0, alarm_delay, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 5
        ,{0, Alarm_6, EE_ALARM }
        #endif
