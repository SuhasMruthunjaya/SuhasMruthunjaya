...
I hereby declare that this report is a presentation of my original work and that no other sources were used other than what is cited.\\
\\
...
\begin{flushright}
    \begin{tabular}{m{5cm}}
        \hspace{14mm}\textbf{Suhas B M}\\ \hline
        \centering\myName \\
    \end{tabular}
\end{flushright}
